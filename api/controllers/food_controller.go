...
func GetAllFoods(c *gin.Context) {
	...
	if query != "" {
		foods, err := models.GetFoodsByName(query, convertedPerPage, (convertedPage-1)*convertedPerPage)
	...
	foods, err := models.GetAllFoods(convertedPerPage, (convertedPage-1)*convertedPerPage)
